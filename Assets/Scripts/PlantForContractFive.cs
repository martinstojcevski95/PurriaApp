...
using UnityEngine;
public class PlantForContractFive : MonoBehaviour
{
    public SinglePlantFive plant;
    public int id;
        ...
        FirebaseDatabase.DefaultInstance
             ...
             .GetValueAsync().ContinueWith(task =>
             {
                 ...
                 else if (task.IsCompleted)
                 {
                     ...
                     plant = JsonUtility.FromJson<SinglePlantFive>(snapshot.GetRawJsonValue());
