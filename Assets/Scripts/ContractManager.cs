...
public class ContractManager : MonoBehaviour
{
    ...
    //    contract.PlantsPlantedTimeForContract = string.Format(" {0}-{1}-{2}", DateTime.Now.Hour, DateTime.Now.Minute, DateTime.Now.Second);
        ...
        Debug.Log(" id za kontrakt za da se kreiraat rastenija e " + int.Parse(ContractDescription.text));
    ...
    //SE OD SEGA KE SE PRAVI SO POP UPS. BILO STO DA KREIRAS KE IMA POP UP I TAKA KE SE RAZMENUVAAT PODATOCI I KE SE ZIMAAT OD BAZA ILI PLEASE WAIT NESTO.
    // od koga ke go kreiram kontraktot posle nekoja sekunda da zemam data od baza od kreiraniot kontrakt, od koa ke ja zemam datada da go napolnam kontraktot, ova treba da se 
    //slusuva sekoe otvaranje na kontrakt
